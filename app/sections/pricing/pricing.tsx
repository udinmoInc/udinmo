...
const plans = [
  {
    name: "Starter",
    price: "$5/mo",
    features: ["1 Website", "10GB SSD", "Free SSL", "Email Support", "Domain $54", "Wordpress", "One click installation"],
    highlighted: false,
  },
  {
    name: "Pro",
    price: "$15/mo",
    features: ["1 Website", "10GB SSD", "Free SSL", "Email Support", "Domain $54", "Wordpress", "One click installation", "Backup", "New Apps Early access", "Ide"],
    highlighted: true,
  },
  {
    name: "Business",
    price: "$30/mo",
    features: ["1 Website", "10GB SSD", "Free SSL", "Email Support", "Domain $54", "Wordpress", "One click installation", "Backup", "New Apps Early access", "Ide", "10 Domains"],
    highlighted: false,
  },
];
...
export default function Pricing() {
  return (
    <section className="bg-[#08090a] py-16 px-4 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[1280px] mx-auto">
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative w-full max-w-[370px] p-6 rounded-2xl shadow-2xl border border-neutral-800 transition-all hover:scale-105 ${
                plan.highlighted
              ...
              // 👆 For 3rd card: Center at md, normal at lg
            >
              {plan.highlighted && (
                <>
